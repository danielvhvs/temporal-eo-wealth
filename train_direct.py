...
def _parse_args() -> argparse.Namespace:
    ...
    # data params
    parser.add_argument(
        '--dataset', default='DHS_incountry_A',  # TODO: choices?
        help='dataset to use')
    parser.add_argument(
    ...
    parser.add_argument(
        '--ls_bands', default="ms", choices=[None, 'rgb', 'ms'],
        help='Landsat bands to use')
    parser.add_argument(
        '--nl_band', default="merge", choices=[None, 'merge', 'split'],
